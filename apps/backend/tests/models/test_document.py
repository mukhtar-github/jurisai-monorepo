...
def test_legal_document_creation(test_db):
    ...
    # Query to verify
    retrieved_doc = test_db.query(LegalDocument).filter_by(title="Test Document").first()
...
def test_document_entity_relationship(test_db):
    ...
    # Query to verify
    retrieved_doc = test_db.query(LegalDocument).filter_by(title="Entity Test Document").first()
...
def test_document_key_terms(test_db):
    ...
    # Query to verify
    retrieved_doc = test_db.query(LegalDocument).filter_by(title="Key Terms Test Document").first()
